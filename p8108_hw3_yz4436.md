...
for each day and use color to indicate day of the week. I made a point
plot and connect each point with geom_line().
...
\* Based on this graph, we could easily see it is the wave pattern and
the range of total_activity is large, which the minimum value is 1440.00
and the maximum is 685910.00. There are totally 35 points in the graph.
...
Then I create separate variables for year, month, and day, and make
reasonable units or temperature, precipitation, and snowfall.
