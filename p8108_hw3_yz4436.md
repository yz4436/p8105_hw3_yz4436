...
could also find that the average max temperature in January spread wider
than the average max temperature in July. According to the plot, we
could see that they all have outliers, since for both January and July,
there are some points that far from the mean part.
