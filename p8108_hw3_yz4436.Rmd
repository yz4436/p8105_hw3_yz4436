...
```
* Based on this graph, we could easily see it is the wave pattern and the range of total_activity is large, which the minimum value is 1440.00 and the maximum is 685910.00.



### Problem 3

Import the dataset ny_noaa.
```{r}
data("ny_noaa")
```
